...
func NewChtIndexer(db essdb.Database, clientMode bool, odr OdrBackend) *core.ChainIndexer {
...
// NewBloomTrieIndexer creates a BloomTrie chain indexer
func NewBloomTrieIndexer(db essdb.Database, clientMode bool, odr OdrBackend) *core.ChainIndexer {
