...
import (
	...
	"github.com/ovcharovvladimir/essentiaHybrid/common/fdlimit"
	...
	"github.com/ovcharovvladimir/essentiaHybrid/dashboard"
	...
	"github.com/ovcharovvladimir/essentiaHybrid/essstats"
	"github.com/ovcharovvladimir/essentiaHybrid/les"
	"github.com/ovcharovvladimir/essentiaHybrid/log"
	"github.com/ovcharovvladimir/essentiaHybrid/metrics"
	"github.com/ovcharovvladimir/essentiaHybrid/metrics/influxdb"
	...
	"github.com/ovcharovvladimir/essentiaHybrid/p2p/netutil"
...
var (
	...
	MinerLegacyGasTargetFlag = cli.Uint64Flag{
		...
		Value: ess.DefaultConfig.MinerGasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: ess.DefaultConfig.MinerGasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimum gas price for mining a transaction",
		Value: ess.DefaultConfig.MinerGasPrice,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: ess.DefaultConfig.MinerRecommit,
	}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	for _, url := range urls {
		...
		if err != nil {
			log.Crit("Bootstrap URL invalid", "essnode", url, "err", err)
		}
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "ESS", ethPeers, "LESS", lightPeers, "total", cfg.MaxPeers)
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ess.Config) {
	...
	case ctx.GlobalBool(DeveloperFlag.Name):
		...
		res, err := ks.Unlock(developer, "")
		if err != nil {
			Fatalf("Failed to unlock developer account: %v", err)
		}
		log.Info("Using developer account", "address", developer.Address, "res", res)
