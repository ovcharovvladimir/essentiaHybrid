...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Engine.Ethash.Params.BlockReward = (*hexutil.Big)(esshash.FrontierBlockReward)
	...
	spec.Engine.Ethash.Params.EIP649Reward = (*hexutil.Big)(esshash.ByzantiumBlockReward)
