...
import (
	...
	"github.com/ovcharovvladimir/essentiaHybrid/miner"
...
func CreateConsensusEngine(ctx *node.ServiceContext, chainConfig *params.ChainConfig, config *esshash.Config, notify []string, noverify bool, db essdb.Database) consensus.Engine {
	...
	case esshash.ModeTest:
		...
		return esshash.NewTester(nil, noverify)
...
func (s *Ethereum) ChainDb() essdb.Database            { return s.chainDb }
