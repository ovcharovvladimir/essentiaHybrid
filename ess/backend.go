...
func CreateConsensusEngine(ctx *node.ServiceContext, chainConfig *params.ChainConfig, config *esshash.Config, notify []string, db essdb.Database) consensus.Engine {
