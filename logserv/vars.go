...
var (
  ...
  TempStr       string = ":8598"                                    // Активный порт
  Remarks       string = "Version testing - 1.027 05.09.2018 10:00"
  Term          string = "TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION"
  Servicestatus string = "Ok"
  Notify        string = "Programm alredy started or port 5555 is busy other service."
)
...
type LogStruct    struct {
     ...
     Operation    string    // Operation in system
     ...
     Unx          int64     // Unix date for ordering and search by date time
}


func (L *LogStruct) Sys(){
     u:=time.Now().UnixNano() / 1000000 
     L.Unx      = u
     L.Id       = L.Project+":"+L.Module+":"+time.Unix(0, u*1000000).Format("20060102150405000")
     L.Datetime = CTM()
}
  ...
  <body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h1 class="jumbotron-heading">Monitorung and loging system</h1>
          <p class="lead text-muted">
             Система для логирования и отчетности.
          </p>
          <p>
            <a href="/rep/log/100" class="btn btn-primary my-2">Main call to action</a>
            <a href="/db/start/"   class="btn btn-secondary my-2">Create action</a>
          </p>
        </div>
      </section>
