...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ovcharovvladimir/essentiaHybrid

    go install github.com/ovcharovvladimir/essentiaHybrid/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ovcharovvladimir/essentiaHybrid`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/ovcharovvladimir/essentiaHybrid
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ovcharovvladimir/essentiaHybrid/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ovcharovvladimir/essentiaHybrid/wiki/Code-Review-Guidelines).
